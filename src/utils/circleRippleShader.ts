...
export const circleRippleUniforms = {
  uResolution: { value: new THREE.Vector2(0, 0) },
  uTime: { value: 10 },
  uColor: { value: new THREE.Color('#45B8FF') }, // color of the shapes
  uClickPos: { value: Array.from({ length: MAX_CLICKS }, () => new THREE.Vector2(-1, -1)) },
  uClickTimes: { value: new Float32Array(MAX_CLICKS) },
  uShapeType: { value: 1 }, // 0=square 1=circle 2=tri 3=diamond
  uPixelSize: { value: 12.5 },
};


export const circleRippleUniformsV1 = {
  uResolution: { value: new THREE.Vector2(0, 0) },
  uTime: { value: 10 },
  uColor: { value: new THREE.Color('#ff0080') }, // color of the shapes
  uClickPos: { value: Array.from({ length: MAX_CLICKS }, () => new THREE.Vector2(-1, -1)) },
  uClickTimes: { value: new Float32Array(MAX_CLICKS) },
  uShapeType: { value: 1 }, // 0=square 1=circle 2=tri 3=diamond
  uPixelSize: { value: 12.5 },
