...
// const int MAX_CLICKS = 10;                  // raise if you like
// const float PIXEL_SIZE = 4.0; // Size of each pixel in the Bayer matrix
// const float CELL_PIXEL_SIZE = 8.0 * PIXEL_SIZE; // 8x8 Bayer matrix


// uniform vec2   uClickUVs  [MAX_CLICKS];
...
//     const float speed     = 0.30;   // wave‑front speed (UV/s)
//     const float thickness = 0.10;  // half‑width of bright ring (UV)
//     const float dampT     = 1.0;    // time attenuation (1/s)
//     const float dampR     = 1.0;    // radial attenuation (1/UV)
